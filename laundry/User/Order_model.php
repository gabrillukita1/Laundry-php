          ...
          <div class="row">
           ...
           <div class="form-group col-lg-12">   
            <div id="Mor_Eve"></div>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Dry Price (Rp <?php echo $Data->Dry_Price; ?>)</label>
            ...
            <?php if($Data->Laundry_Price>0){?>
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Laundry Price (Rp <?php echo $Data->Laundry_Price; ?>)</label>
            ...
            <?php }?>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Jumlah laundry (kg)</label>
