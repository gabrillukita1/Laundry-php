...
$pos = strpos($pfile, 'password_change');
...
?>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">DASHBOARD | Welcome  <?php echo $_SESSION['User_NAME'] ?></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item <?php echo(isset($is_menu_list)?' active' : '')?>" data-toggle="tooltip" data-placement="right" title="Make a New Order">
          <a class="nav-link" href="menu_list.php">
            <i class="fa fa-fw fa-paper-plane"></i>
            <span class="nav-link-text">Make a New Order</span>
        ...
        <li class="nav-item <?php echo(isset($is_password_change)?' active' : '')?>" data-toggle="tooltip" data-placement="right" title="Change Password">
          <a class="nav-link" href="password_change.php">
